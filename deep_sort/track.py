...
class Track:
    """
    A single target track with state space `(x, y, a, h)` and associated velocities where `(x, y)` is 
    the center of the bounding box, `a` is the aspect ratio and `h` is the height.
